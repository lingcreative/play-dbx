...
import dbx.jdbc.IsolationLevelDataSourceAdapter;
import dbx.jndi.JndiTemplate;
import dbx.transaction.*;
import dbx.transaction.support.AbstractPlatformTransactionManager;
import dbx.transaction.support.DefaultTransactionStatus;
import dbx.transaction.support.TransactionSynchronization;
import dbx.util.Assert;
import dbx.util.StringUtils;
import dbx.transaction.CannotCreateTransactionException;
import dbx.transaction.HeuristicCompletionException;
import dbx.transaction.IllegalTransactionStateException;
import dbx.transaction.InvalidIsolationLevelException;
import dbx.transaction.NestedTransactionNotSupportedException;
import dbx.transaction.TransactionDefinition;
import dbx.transaction.TransactionSuspensionNotSupportedException;
import dbx.transaction.TransactionSystemException;
import dbx.transaction.UnexpectedRollbackException;
...
public class JtaTransactionManager extends AbstractPlatformTransactionManager
		implements TransactionFactory, Serializable {
	 ...
	 * @see IsolationLevelDataSourceAdapter
